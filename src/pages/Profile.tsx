        ...
        <div>
          {items.length === 0 ? (
            ...
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
              {items.map((item) => (
                <div key={item.ownerRowId} className="glass rounded-2xl overflow-hidden">
          ...
          <div className="relative overflow-hidden rounded-2xl p-5"
            ...
            <div className="flex items-center gap-2.5 mb-3 relative">
              <div className="w-9 h-9 rounded-xl flex items-center justify-center"
                ...
                <Gift className="h-4 w-4" style={{ color: "oklch(0.72 0.22 145)" }} />
              </div>
              <div>
            ...
            <div className="relative mb-3">
              ...
              <div className="flex items-center gap-2">
                <div className="flex-1 rounded-xl px-4 py-3.5 font-mono text-2xl font-black text-center"
